                  ...
                  children: [
                      ...
                      children: [
                        ...
                        if (index >= 2)
                          IconButton(
                            ...
                            onPressed: () => flightDateController.removeFlight(index),
                          ),
                      ],
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        DateSelectionField(
                          initialDate: flightDateController.flights[index]['date'],
                          fontSize: 12,
                          onDateChanged: (date) {
                            flightDateController.updateMultiCityFlightDate(index, date);
                          },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(() => DateSelectionField(
                        initialDate: flightDateController.departureDate.value,
                        fontSize: 12,
                        onDateChanged: (date) {
                          flightDateController.updateDepartureDate(date);
                        },
                        firstDate: DateTime.now(),
                      )),
                    ],
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Obx(() => DateSelectionField(
                          initialDate: flightDateController.returnDate.value,
                          fontSize: 12,
                          onDateChanged: (date) {
                            flightDateController.updateReturnDate(date);
                          },
                          minDate: flightDateController.getMinReturnDate(),
                        )),
                      ],
                    ),
                  ),
